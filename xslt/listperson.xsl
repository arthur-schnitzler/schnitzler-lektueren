...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title">
            <xsl:value-of
                select="concat(.//tei:listPerson/tei:persName[1]/tei:forename/text(), ' ', .//tei:listPerson/tei:persName[1]/tei:surname/text())"
            />
        </xsl:variable>
                                        ...
                                        <xsl:for-each select=".//tei:person[@xml:id]">
                                            ...
                                            <tr>
                                                <td>
                                                  ...
                                                  <xsl:value-of
                                                  select="tei:persName[1]/tei:surname/text()"/>
                                                  </a>
                                                </td>
                                                <td>
                                                  <a>
                                                  ...
                                                  <xsl:value-of
                                                  select="tei:persName[1]/tei:forename/text()"/>
                                                  </a>
                                                </td>
                                                <td>
                                                  <a>
                                                  ...
                                                  <xsl:choose>
                                                  <xsl:when
                                                  test="tei:birth/tei:date and tei:death/tei:date">
                                                  <xsl:choose>
                                                  <xsl:when
                                                  test="contains(tei:birth/tei:date/text(), '.') or contains(tei:death/tei:date/text(), '.')">
                                                  <xsl:value-of
                                                  select="concat(tei:birth/tei:date, ' – ', tei:death/tei:date)"
                                                  />
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                  <xsl:value-of
